module ConCom where
-- THIS IS FROM McBride's github
-- https://github.com/pigworker/Samizdat/blob/master/ConCom.agda
-- comments are my own

-- pulled from twitter post https://twitter.com/PTOOP/status/1450435311415308292
...
-- no.. composition for dependent functions?
_-_ : forall {i j k}
